...
public class Issue4083IT {
    ...
    public void testValidateWholeBean() throws Exception {
        // the 'http://localhost:8080/validateWholeBean/' should be replaced by 'webUrl'
        HtmlPage page = webClient.getPage("http://localhost:8080/validateWholeBean/" + "faces/Issue4083.xhtml");
