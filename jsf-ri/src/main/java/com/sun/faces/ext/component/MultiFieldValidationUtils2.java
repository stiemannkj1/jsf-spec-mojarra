...
class MultiFieldValidationUtils2 {
    ...
    static class AddRemainingCandidateFieldsCallback implements VisitCallback {
        ...
        protected final Map<String, Map<String, Object>> getCandidate() {
            return candidate;
        }
